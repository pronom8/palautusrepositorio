...
class TestKauppa(unittest.TestCase):
    ...
    def test_viisi(self):
        ...
        self.kauppa.tilimaksu("Jonne", "82822")
        self.kauppa.lisaa_koriin(1)
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("Nekka", "123456")

        self.pankki_mock.tilisiirto.assert_called_with("Nekka", 42, "123456", ANY, 5)

    def test_remove_juttu_from_cart(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
